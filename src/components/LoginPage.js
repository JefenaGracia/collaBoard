...
const LoginPage = () => {
  ...
  // Google Login
  const googleLogin = async (isDemo = false) => {
    try {
  ...
  // Email & Password Login accepts optional credentials.
  const emailPasswordLogin = async (loginEmail = email, loginPassword = password) => {
    ...
    try {
      ...
      handleUserLogin(loginEmail, user.displayName);
    } catch (error) {
...
const handleUserLogin = async (userEmail, userName) => {
  ...
  addMessage("success", userName ? `Welcome, ${userName}!` : "Welcome!");
  ...
  return (
    <div className="login-container">
      <div className="login-box">
        ...
        {/* Google Login Button */}
        <button className="googlebutton" onClick={() => googleLogin(false)}>
        ...
        <button
          ...
          onClick={() => {
            // Call emailPasswordLogin with demo credentials directly.
            emailPasswordLogin("guest_user@gmail.com", "checking_it_out");
          }}
        >
          View Demo
        </button>
